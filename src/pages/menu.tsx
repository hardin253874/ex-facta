    ...
    <div className="min-h-screen flex flex-col relative">
      ...
      {openPopup && (
        <Modal
          ...
          title={openPopup.charAt(0).toUpperCase() + openPopup.slice(1) + ' Information'}
